<x-layout>
    ...
    <div id="informatie_container" class="max-w-7xl mx-auto p-6">
        ...
        <div class="flex flex-col md:flex-row justify-between gap-6">
            <!-- Reden 1 -->
            <div class="flex-1 basis-1/3 flex flex-col items-center text-center md:text-left md:items-start bg-gray-100 p-6 rounded-lg shadow-lg">
                <h2 class="text-5xl font-bold text-green-600 mb-4">1</h2>
                <p class="text-lg font-semibold text-green-800">Plaats een vacature</p>
            ...
            <!-- Reden 2 -->
            <div class="flex-1 basis-1/3 flex flex-col items-center text-center md:text-left md:items-start bg-gray-100 p-6 rounded-lg shadow-lg">
                <h2 class="text-5xl font-bold text-green-600 mb-4">2</h2>
                <p class="text-lg font-semibold text-green-800">Kandidaten melden zich aan</p>
                <p class="text-gray-700">
            ...
            <!-- Reden 3 -->
            <div class="flex-1 basis-1/3 flex flex-col items-center text-center md:text-left md:items-start bg-gray-100 p-6 rounded-lg shadow-lg">
                <h2 class="text-5xl font-bold text-green-600 mb-4">3</h2>
                <p class="text-lg font-semibold text-green-800">Automatische selectie</p>
                <p class="text-gray-700">
    ...
    <div id="why_container" class="max-w-7xl mx-auto p-6 mb-20">
        ...
        <div class="flex flex-col md:flex-row justify-between gap-6">
            ...
            <div class="flex-1 basis-1/3 flex flex-col items-center text-center md:text-left md:items-start bg-gray-100 p-6 rounded-lg shadow-lg">
                ...
                <p class="text-gray-700">
                    Met Open Hiring wordt het traditionele wervingsproces gestroomlijnd. Er is geen tijdrovende selectieprocedure nodig.
                    Vacatures worden eenvoudig ingevuld door de eerstvolgende beschikbare kandidaten in de wachtrij, waardoor je snel kunt schakelen en nieuwe medewerkers direct aan de slag kunnen.
                </p>
            </div>
            <!-- Reden 2 -->
            <div class="flex-1 basis-1/3 flex flex-col items-center text-center md:text-left md:items-start bg-gray-100 p-6 rounded-lg shadow-lg">
                ...
                <p class="text-gray-700">
                    Open Hiring richt zich op kansen voor iedereen. Zonder uitgebreide sollicitatieprocedures krijgen werkzoekenden de kans om zich te bewijzen op basis van hun inzet, niet hun CV. Dit versterkt een inclusieve en sociale bedrijfsvoering.
                </p>
            </div>
            <!-- Reden 3 -->
            <div class="flex-1 basis-1/3 flex flex-col items-center text-center md:text-left md:items-start bg-gray-100 p-6 rounded-lg shadow-lg">
                ...
                <p class="text-gray-700">
                    Door het weglaten van traditionele selectieprocessen bespaar je niet alleen op wervingskosten, maar ook op tijd. Met ons eenvoudige systeem plaats je snel een vacature en laat je de rest aan ons over.
                </p>
            </div>
        </div>
    </div>
